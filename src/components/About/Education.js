...
function Education() {
  const edu = [
    ...
    },
    {
      ...
      place: "Oasis Residential Public School, Patna",
      year: "2020",
      score: "92%",
      description: "Completed with a strong foundation in core subjects like Mathematics, English, and Science.",
    },
  ];
